    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="{{ Request::segment(1) == $item->route ? 'active' : '' }}">
                @if ($item->induk == 'head')
                    <a href="/{{ $item->route }} " class=""><i class="fa fa-th-large"></i> <span
            ...
            @if (session()->get('role') == 'admin')
                <li class="{{ Request::segment(1) == 'pegawai' ? 'active' : '' }}">
                    <a href="{{ URL::route('pegawai.index') }}"><i class="fa fa-user-circle"></i> <span
                            class="nav-label ">PEGAWAI</span></span></a>
                </li>
                <li class="{{ Request::segment(1) == 'adm-menu' ? 'active' : '' }}">
                    <a href="{{ URL::route('adm-menu.index') }}"><i class="fa fa-th-large"></i> <span
                            class="nav-label ">ADM MENU</span></span></a>
                </li>
                <li class="{{ Request::segment(1) == 'adm-role' ? 'active' : '' }}">
                    <a href="{{ URL::route('adm-role.index') }}"><i class="fa fa-id-card"></i> <span
                            class="nav-label ">ADM ROLE</span></span></a>
                </li>
                <li class="{{ Request::segment(1) == 'adm-role-menu' ? 'active' : '' }}">
                    <a href="{{ URL::route('adm-role-menu.index') }}"><i class="fa fa-th-large"></i> <span
