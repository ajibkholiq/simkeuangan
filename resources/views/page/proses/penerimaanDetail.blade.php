        ...
        <div class="col-md-6" style="margin-bottom: 30px">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form method="post" action="{{ URL::route('penerimaan.store') }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3" style="text-align: end">
                                ...
                                <a href="{{route('penerimaan.show',$data->uuid)}}" target="blank" class="btn btn-primary">Cetak Bukti</a>
