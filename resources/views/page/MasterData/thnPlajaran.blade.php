...
<div class="row" style="margin-top:10px">
          ...
          @endif
            ...
            <div class="col-md-12">
                <a data-toggle="modal"href="#add-thn" class="btn btn-primary" style="justify-items: end"><i class="fa fa-plus"></i> Add Tahun Pelajaran</a>
            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody >
                                        ...
                                        <td style="display: flex; justify-content:center; gap: 10px" >
                                                ...
                                                <button id="btn-act-thnpljrn" class="btn btn-outline {{$data->status == 'AKTIF' ?  'btn-warning fa fa-check-square-o ' : 'btn-primary fa fa-square-o ' }} " id="aktif" data-id="{{$data->uuid}}" data-status="{{$data->status}}"></button>
                                                <form action="{{route("tahun_pelajaran.destroy",$data->uuid)}}" method="POST" onsubmit="return confirm('Apakah Anda Yakin ?');">
                                                    @csrf
                                                    @method("DELETE")
                            ...
                            <form method="post" action="{{URL::Route('tahun_pelajaran.store')}}"class="form-horizontal">
                                ...
                                <div class="hr-line-dashed"></div>
                                 <div class="form-group"><label class="col-sm-2 control-label">Tahun Pelajaran</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" placeholder="Tahun Pelajaran" name="tahun" required class="form-control"></div>
                                </div>
