...
<div class="row" style="margin-top:10px">
          ...
          @endif
            ...
            <div class="col-md-12">
                <a data-toggle="modal"href="#add-kelas" class="btn btn-primary" style="justify-items: end"><i class="fa fa-plus"></i> Add Kelas</a>
            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody >
                                        ...
                                        <td style="display: flex; justify-content:center; gap: 10px" >
                                                ...
                                                <button id="btn-kelas" class="btn btn-outline btn-warning fa fa-pencil " id="aktif" data-id="{{$data->uuid}}"></button>
                                                <form action="{{route("kelas.destroy",$data->uuid)}}" method="POST" onsubmit="return confirm('Apakah Anda Yakin ?');">
                                                    @csrf
                                                    @method("DELETE")
                            ...
                            <form method="post" action="{{URL::Route('kelas.store')}}"class="form-horizontal">
                                ...
                                <div class="hr-line-dashed"></div>
                                 <div class="form-group"><label class="col-sm-2 control-label">Nama Kelas</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" placeholder="Nama Kelas" name="kelas" required class="form-control"></div>
                                </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="hr-line-dashed"></div>
                                 <div class="form-group"><label class="col-sm-2 control-label">Nama Kelas</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" placeholder="Nama Kelas" name="kelas" id="kelas" required class="form-control"></div>
                                </div>
                                 <div class="form-group"><label class="col-sm-2 control-label">Tingkat</label>
                                    <div class="col-sm-10">
                                 ...
                                 <div class="form-group"><label class="col-sm-2 control-label">Remark</label>
                                    <div class="col-sm-10"><input type="text" placeholder="Remark" id="remark" name="remark" required class="form-control"></div>
                                 </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <div class="col-sm-10 col-sm-offset-2" style="text-align: end">
