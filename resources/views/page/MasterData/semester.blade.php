...
<div class="row" style="margin-top:10px">
          ...
          @endif
            ...
            <div class="col-md-12">
                <a data-toggle="modal"href="#add-smt" class="btn btn-primary" style="justify-items: end"><i class="fa fa-plus"></i> Add Semester</a>
            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody >
                                        ...
                                        <td style="display: flex; justify-content:center; gap: 10px" >
                                                ...
                                                <button id="btn-act-smtr" class="btn btn-outline {{$data->status == 'AKTIF' ?  'btn-warning fa fa-check-square-o ' : 'btn-primary fa fa-square-o ' }} " id="aktif" data-id="{{$data->uuid}}" data-status="{{$data->status}}"></button>
                                                <form action="{{route("semester.destroy",$data->uuid)}}" method="POST" onsubmit="return confirm('Apakah Anda Yakin ?');">
                                                    @csrf
                                                    @method("DELETE")
                            ...
                            <form method="post" action="{{URL::Route('semester.store')}}"class="form-horizontal">
                                ...
                                <div class="hr-line-dashed"></div>
                                 <div class="form-group"><label class="col-sm-2 control-label">Semester</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" placeholder="Semester" name="semester" required class="form-control"></div>
                                </div>
