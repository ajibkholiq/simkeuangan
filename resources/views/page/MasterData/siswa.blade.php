...
<div class="row" style="margin-top:10px">
          ...
          @endif
            ...
            <div class="col-md-12">
                <button id="btn-add" class="btn btn-primary" style="justify-items: end"><i class="fa fa-plus"></i> Add Kelas</button>
            </div>
                            ...
                            <form method="post" action="{{URL::Route('siswa.store')}}"class="form-horizontal">
                                ...
                                <div class="hr-line-dashed"></div>
                                 <div class="form-group"><label class="col-sm-3 control-label">Nama</label>
                                    ...
                                    <div class="col-sm-9"><input type="text" placeholder="Nama" name="nama" required class="form-control"></div>
                                </div>
                                <div class="form-group"><label class="col-sm-3 control-label">Kelas</label>
                                 ...
                                 <div class="form-group"><label class="col-sm-3 control-label">Nama Ayah</label>
                                    <div class="col-sm-9"><input type="text" placeholder="Nama Ayah" name="ayah" required class="form-control"></div>
                                </div>
                                  <div class="form-group"><label class="col-sm-3 control-label">Nama Ibu</label>
                                    <div class="col-sm-9"><input type="text" placeholder="Nama Ibu" name="ibu" required class="form-control"></div>
                                </div>
                                  <div class="form-group"><label class="col-sm-3 control-label">No Hp</label>
                                    <div class="col-sm-9"><input type="text" placeholder="No Hp" name="nohp" required class="form-control"></div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-3 control-label">Kecamatan</label>
                                 ...
                                 <div class="form-group"><label class="col-sm-3 control-label">Kelurahan / Desa</label>
                                    ...
                                    <div class="col-sm-9"><input type="text" placeholder="Alamat" name="alamat" required class="form-control"></div>
                                </div>
                                 <div class="form-group"><label class="col-sm-3 control-label">Remark</label>
                                    <div class="col-sm-9"><input type="text" placeholder="Remark" name="remark" required class="form-control"></div>
                                 </div>
                                <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="hr-line-dashed"></div>
                                 <div class="form-group"><label class="col-sm-3 control-label">Nama</label>
                                    ...
                                    <div class="col-sm-9"><input type="text" placeholder="Nama" name="nama" id="nama" required class="form-control"></div>
                                </div>
                                <div class="form-group"><label class="col-sm-3 control-label">Kelas</label>
                                    <div class="col-sm-9">
                                 ...
                                 <div class="form-group"><label class="col-sm-3 control-label">Nama Ayah</label>
                                    <div class="col-sm-9"><input type="text" placeholder="Nama Ayah" id="ayah" required class="form-control"></div>
                                </div>
                                  <div class="form-group"><label class="col-sm-3 control-label">Nama Ibu</label>
                                    <div class="col-sm-9"><input type="text" placeholder="Nama Ibu" id="ibu"  required class="form-control"></div>
                                </div>
                                  <div class="form-group"><label class="col-sm-3 control-label">No Hp</label>
                                    <div class="col-sm-9"><input type="text" placeholder="No Hp" id='nohp' required class="form-control"></div>
                                </div>
                                <div id="edit-alamat">
                                <div class="form-group"><label class="col-sm-3 control-label">Provinsi</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group"><label class="col-sm-3 control-label">Kecamatan</label>
                                 ...
                                 <div class="form-group"><label class="col-sm-3 control-label">Kelurahan / Desa</label>
                                    ...
                                    <div class="form-group"><label class="col-sm-3 control-label">Alamat</label>
                                    <div class="col-sm-9"><input type="text" placeholder="Alamat" id="alamat"  required class="form-control"></div>
                                </div>
                                </div>
                                 <div class="form-group"><label class="col-sm-3 control-label">Remark</label>
                                    <div class="col-sm-9"><input type="text" placeholder="Remark" id="remark"  required class="form-control"></div>
                                 </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <div class="col-sm-9 col-sm-offset-3" style="text-align: end">
...
$('#show-alamat').click(function(){ $('#edit-alamat').show();}) ;
