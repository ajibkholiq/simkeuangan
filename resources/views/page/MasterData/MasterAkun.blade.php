                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-3 control-label">Kode Akun</label>
                            ...
                            <div class="col-sm-9"><input type="text" placeholder="Kode Akun" name="kode"
                                    id="kode" required class="form-control"></div>
                        </div>
                        <div class="form-group"><label class="col-sm-3 control-label">Nama</label>

                            <div class="col-sm-9"><input type="text" placeholder="Akun" name="nama" id="nama"
